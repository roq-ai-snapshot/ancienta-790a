...
function PhotoViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<PhotoInterface>(
    ...
    () =>
      getPhotoById(id, {
        relations: ['user', 'organization', 'comment', 'favorite'],
      }),
  );
              ...
              {hasAccess('comment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/comments/create?photo_id=${data?.id}`}>
              ...
              {hasAccess('favorite', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/favorites/create?photo_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
